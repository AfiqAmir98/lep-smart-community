...
import 'package:psm_project/src/features/authentication/screens/reservation/reservation_view_screen.dart';
...
class ReservationListViewScreen extends StatelessWidget {
  const ReservationListViewScreen({Key? key}) : super(key: key);
                        ...
                        itemBuilder: (c, index){
                          ...
                          return GestureDetector(
                              onTap: () async {
                                ...
                                Get.to(() => ReservationViewScreen(reservation: detailedReservation));
                              },
                              child: Column(
                                children: [
                                  ListTile(
